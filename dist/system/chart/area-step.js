...
System.register(['aurelia-charts', './two-dimensional'], function (_export, _context) {
  ...
  var scales, chart, quan, TwoDimensional, _dec, _dec2, _class, AreaStepChart;
  ...
  return {
    ...
    execute: function () {
      _export('AreaStepChart', AreaStepChart = (_dec = scales([quan, quan]), _dec2 = chart('C3', 'areaStep'), _dec(_class = _dec2(_class = function (_TwoDimensional) {
        _inherits(AreaStepChart, _TwoDimensional);
      ...
      _export('AreaStepChart', AreaStepChart);
    }
  };
});