...
System.register(['aurelia-charts', './one-dimensional'], function (_export, _context) {
  ...
  var scales, chart, quan, OneDimensional, _dec, _dec2, _class, PieChart;
  ...
  return {
    ...
    execute: function () {
      _export('PieChart', PieChart = (_dec = scales([quan]), _dec2 = chart('C3', 'pie'), _dec(_class = _dec2(_class = function (_OneDimensional) {
