...
System.register(['aurelia-charts', './two-dimensional'], function (_export, _context) {
  ...
  var scales, chart, quan, TwoDimensional, _dec, _dec2, _class, StepChart;
  ...
  return {
    ...
    execute: function () {
      _export('StepChart', StepChart = (_dec = scales([quan, quan]), _dec2 = chart('C3', 'step'), _dec(_class = _dec2(_class = function (_TwoDimensional) {
