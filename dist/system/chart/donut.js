...
System.register(['aurelia-charts', './one-dimensional'], function (_export, _context) {
  ...
  var scales, chart, quan, OneDimensional, _dec, _dec2, _class, DonutChart;
  ...
  return {
    ...
    execute: function () {
      _export('DonutChart', DonutChart = (_dec = scales([quan]), _dec2 = chart('C3', 'donut'), _dec(_class = _dec2(_class = function (_OneDimensional) {
        _inherits(DonutChart, _OneDimensional);
