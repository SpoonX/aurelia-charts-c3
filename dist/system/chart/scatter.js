...
System.register(['aurelia-charts', './two-dimensional'], function (_export, _context) {
  ...
  var quan, scales, chart, TwoDimensional, _dec, _dec2, _class, ScatterChart;
  ...
  return {
    ...
    execute: function () {
      _export('ScatterChart', ScatterChart = (_dec = scales([quan, quan]), _dec2 = chart('C3', 'scatter'), _dec(_class = _dec2(_class = function (_TwoDimensional) {
      ...
      _export('ScatterChart', ScatterChart);
    }
  };
});